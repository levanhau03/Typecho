        ...
        <div class="joe_container joe_bread">
            <ul class="joe_bread__bread">
                <li class="item">
                    ...
                    <a href="<?php $this->options->siteUrl(); ?>" class="link" title="Trang chủ">Trang chủ</a>
                </li>
                <li class="line">/</li>
        ...
        <div class="joe_container">
            <div class="joe_main joe_post">
                        ...
                        <div class="joe_detail__overdue">
                            <div class="joe_detail__overdue-wrapper">
                                <div class="title">
                                    ...
                                    <span class="text">Lời khuyên:</span>
                                </div>
                                <div class="content">
                                    Bài viết này được cập nhật lần cuối vào <?php echo date('Y/m/d', $this->modified); ?>, quá <?php echo floor((time() - ($this->modified)) / 86400); ?> ngày vẫn chưa được cập nhật, nếu nội dung hoặc hình ảnh không hợp lệ, vui lòng để lại lời nhắn và phản hồi.
                                </div>
                            </div>
                        </div>
                    <?php endif; ?>
                ...
                <ul class="joe_post__pagination">
                    <?php $this->theNext('<li class="joe_post__pagination-item prev">%s</li>', '', ['title' => 'Trước']); ?>
                    <?php $this->thePrev('<li class="joe_post__pagination-item next">%s</li>', '', ['title' => 'Kế tiếp']); ?>
                </ul>
