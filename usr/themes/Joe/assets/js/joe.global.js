document.addEventListener('DOMContentLoaded', () => {
	...
	/* 激活侧边栏人生倒计时功能 */
	{
		if ($('.joe_aside__item.timelife').length) {
			let timelife = [
				{ title: 'Hôm nay kết thúc', endTitle: '小时', num: 0, percent: '0%' },
				{ title: '这周已经过去', endTitle: '天', num: 0, percent: '0%' },
				{ title: '本月已经过去', endTitle: '天', num: 0, percent: '0%' },
				{ title: 'Năm nay đã trôi qua', endTitle: '个月', num: 0, percent: '0%' }
			];
			{
	...
	{
		let motto = Joe.MOTTO;
		if (!motto) motto = 'Có tiền thì lấy chồng, không có tiền thì tận mắt chứng kiến.';
