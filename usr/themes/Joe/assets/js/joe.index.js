                    ...
                    <li class="joe_list__item wow default">
                        ...
                        <div class="information">
                            <a href="${_.permalink}" class="title" title="${_.title}" target="_blank" rel="noopener noreferrer">
                                <span class="badge" style="display: ${_.type === 'sticky' ? 'inline-block' : 'none'}">Top</span>${_.title}
                            </a>
                            <a class="abstract" href="${_.permalink}" title="Tóm tắt bài viết" target="_blank" rel="noopener noreferrer">${_.abstract}</a>
                            <div class="meta">
                                <ul class="items">
                                    <li>${_.created}</li>
                                    <li>${_.views} xem</li>
                                    <li>${_.commentsNum} bình luận</li>
                                    <li>${_.agree} thích</li>
                                </ul>
				...
				$.ajax({
					...
					success(res) {
						if (res.data.length === 0) {
							...
							$('.joe_load').html('Xem thêm');
							$('.joe_load').hide();
							$('.joe_index__list .joe_list__loading').hide();
							return Qmsg.warning('Không còn nội dung');
						}
