<?php if (sizeof($this->categories) > 0 || $this->user->uid == $this->authorId) : ?>
    <div class="joe_detail__category">
        ...
        <?php if ($this->user->uid == $this->authorId) : ?>
            <?php if ($this->is('post')) : ?>
                <a class="edit" target="_blank" rel="noopener noreferrer" href="<?php $this->options->adminUrl(); ?>write-post.php?cid=<?php echo $this->cid; ?>">Chỉnh sửa bài viế</a>
            <?php else : ?>
                <a class="edit" target="_blank" rel="noopener noreferrer" href="<?php $this->options->adminUrl(); ?>write-page.php?cid=<?php echo $this->cid; ?>">Chỉnh sửa trang</a>
            <?php endif; ?>
        <?php endif; ?>
    </div>
<?php endif; ?>
    ...
    <div class="joe_detail__count-information">
        ...
        <div class="meta">
            ...
            <div class="item">
                ...
                <span class="text"><?php $this->commentsNum('%d'); ?> Bình luận</span>
                <span class="line">/</span>
                <span class="text" id="Joe_Article_Views"><?php _getViews($this); ?> xem</span>
                <span class="line">/</span>
                <span class="text" id="Joe_Baidu_Record">Đang kiểm tra để đưa vào...</span>
            </div>
        </div>
    </div>
