<header class="joe_header <?php echo $this->is('post') ? 'current' : '' ?>">
    ...
    <div class="joe_header__above">
        <div class="joe_container">
            ...
            <nav class="joe_header__above-nav">
                <a class="item <?php echo $this->is('index') ? 'active' : '' ?>" href="<?php $this->options->siteUrl(); ?>" title="Trang chủ">Trang chủ</a>
            ...
            <form class="joe_header__above-search" method="post" action="<?php $this->options->siteUrl(); ?>">
                <input maxlength="16" autocomplete="off" placeholder="Nhập các từ khóa..." name="s" value="<?php echo $this->is('search') ? $this->archiveTitle(' &raquo; ', '', '') : '' ?>" class="input" type="text" />
                ...
                <nav class="result">
                    ...
                    <?php while ($item->next()) : ?>
                        <a href="<?php $item->permalink(); ?>" title="<?php $item->title(); ?>" class="item">
                            ...
                            <span class="views"><?php echo number_format($item->views); ?> Xem</span>
                        </a>
                        <?php $index++; ?>
                    <?php endwhile; ?>
                </nav>
                    ...
                    <div class="joe_dropdown" trigger="click">
                        ...
                        <nav class="joe_dropdown__menu">
                            <?php if ($this->user->group == 'administrator' || $this->user->group == 'editor' || $this->user->group == 'contributor') : ?>
                                <a rel="noopener noreferrer nofollow" target="_blank" href="<?php $this->options->adminUrl("manage-posts.php"); ?>">Quản lý bài viết</a>
                            <?php endif; ?>
                            <?php if ($this->user->group == 'administrator' || $this->user->group == 'editor') : ?>
                                <a rel="noopener noreferrer nofollow" target="_blank" href="<?php $this->options->adminUrl("manage-comments.php"); ?>">Quản lý bình luận</a>
                            <?php endif; ?>
                            <?php if ($this->user->group == 'administrator') : ?>
                                <a rel="noopener noreferrer nofollow" target="_blank" href="<?php $this->options->adminUrl("options-theme.php"); ?>">Sửa đổi giao diện</a>
                            <?php endif; ?>
                            <a rel="noopener noreferrer nofollow" target="_blank" href="<?php $this->options->adminUrl(); ?>">AdminCP</a>
                            <a href="<?php $this->options->logoutUrl(); ?>">Đăng xuất</a>
                        </nav>
                    </div>
                <?php else : ?>
                    <div class="item">
                        ...
                        <a href="<?php $this->options->adminUrl('login.php'); ?>" target="_blank" rel="noopener noreferrer nofollow">Đăng nhập</a>
                        <?php if ($this->options->allowRegister) : ?>
                            <span class="split">/</span>
                            <a href="<?php $this->options->adminUrl('register.php'); ?>" target="_blank" rel="noopener noreferrer nofollow">Đăng ký</a>
                        <?php endif; ?>
                    </div>
                <?php endif; ?>
            </div>
    ...
    <div class="joe_header__slideout">
        <img width="100%" height="150" class="joe_header__slideout-image" src="<?php $this->options->JAside_Wap_Image() ?>" alt="Hình nền thanh bên" />
        <div class="joe_header__slideout-author">
            <img width="50" height="50" class="avatar lazyload" src="<?php _getAvatarLazyload(); ?>" data-src="<?php $this->options->JAside_Author_Avatar ? $this->options->JAside_Author_Avatar() : _getAvatarByMail($this->author->mail) ?>" alt="Biệt hiệu Blogger" />
            <div class="info">
        ...
        <ul class="joe_header__slideout-count">
            ...
            <li class="item">
                ...
                <span>Tổng cộng có <strong><?php echo number_format($count->publishedPostsNum); ?></strong> bài viết đã được đăng</span>
            </li>
            <li class="item">
                <svg class="icon" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" width="15" height="15">
                    <path d="M921.6 153.6H102.4A102.4 102.4 0 0 0 0 256v512a102.4 102.4 0 0 0 102.4 102.4h819.2A102.4 102.4 0 0 0 1024 768V256a102.4 102.4 0 0 0-102.4-102.4zM687.616 473.088L972.8 258.304V791.04zM960 204.8L527.104 527.36 73.216 204.8zM371.2 483.584l-320 287.232V256zM73.984 819.2l339.2-307.2 83.456 59.392a51.2 51.2 0 0 0 60.416 0l89.6-67.328L931.072 819.2z" />
                </svg>
                <span>Đã nhận được tổng cộng <strong><?php echo number_format($count->publishedCommentsNum); ?></strong> bình luận</span>
            </li>
        </ul>
        <ul class="joe_header__slideout-menu panel-box">
            <li>
                <a class="link" href="<?php $this->options->siteUrl(); ?>" title="Trang chủ">
                    <span>Trang chủ</span>
                </a>
            </li>
            <!-- 栏目 -->
