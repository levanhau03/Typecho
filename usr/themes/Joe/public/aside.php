<aside class="joe_aside">
    <section class="joe_aside__item author">
        <img width="100%" height="120" class="image lazyload" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="<?php $this->options->JAside_Author_Image() ?>" alt="Hình nền thanh Blogger" />
        <div class="user">
            <img width="75" height="75" class="avatar lazyload" src="<?php _getAvatarLazyload(); ?>" data-src="<?php $this->options->JAside_Author_Avatar ? $this->options->JAside_Author_Avatar() : _getAvatarByMail($this->author->mail) ?>" alt="Hình đại diện trên Blogger" />
        ...
        <div class="count">
            <div class="item" title="Tích lũy số lượng bài viết">
                <span class="num"><?php echo number_format($item->publishedPostsNum); ?></span>
                <span>bài viết</span>
            </div>
            <div class="item" title="Số lượng bình luận tích lũy">
    ...
    <?php if ($this->options->JAside_Timelife_Status === 'on') : ?>
        <section class="joe_aside__item timelife">
            <div class="joe_aside__item-title">
                ...
                <span class="text">Đếm ngược cuộc sống</span>
        ...
        <?php if (count($historyTodaylist) > 0) : ?>
            <section class="joe_aside__item today">
                <div class="joe_aside__item-title">
                    ...
                    <span class="text">Năm đó hôm nay</span>
                    <span class="line"></span>
                </div>
    ...
    <?php if ($this->options->JAside_Hot_Num && $this->options->JAside_Hot_Num !== 'off') : ?>
        <section class="joe_aside__item hot">
            <div class="joe_aside__item-title">
                ...
                <span class="text">Các bài viết phổ biến</span>
                <span class="line"></span>
            </div>
            ...
            <ol class="joe_aside__item-contain">
                <?php if ($item->have()) : ?>
                        ...
                        <li class="item">
                            <a class="link" href="<?php $item->permalink(); ?>" title="<?php $item->title(); ?>">
                                ...
                                <div class="describe">
                                    ...
                                    <span><?php $item->views(); ?> xem - <?php $item->date('m/d'); ?></span>
                                </div>
                            </a>
                        </li>
                        <?php $index++; ?>
                    <?php endwhile; ?>
                <?php else : ?>
                    <li class="empty">Blogger này thật lười biếng!</li>
                <?php endif; ?>
            </ol>
        </section>
    <?php endif; ?>
    <?php if ($this->options->JAside_Newreply_Status === 'on' && $this->options->JCommentStatus !== 'off') : ?>
        <section class="joe_aside__item newreply">
            <div class="joe_aside__item-title">
                ...
                <span class="text">Trả lời mới nhất</span>
                <span class="line"></span>
            </div>
            ...
            <ul class="joe_aside__item-contain">
                <?php if ($item->have()) : ?>
                    ...
                    <?php endwhile; ?>
                <?php else : ?>
                    <li class="empty">Kém nổi tiếng! Không trả lời!</li>
                <?php endif; ?>
            </ul>
        </section>
    <?php endif; ?>
    <?php if ($this->options->JAside_Weather_Key) : ?>
        <section class="joe_aside__item weather" data-key="<?php $this->options->JAside_Weather_Key() ?>" data-style="<?php $this->options->JAside_Weather_Style() ?>">
            <div class="joe_aside__item-title">
                ...
                <span class="text">Thời tiết ngày hôm nay</span>
                <span class="line"></span>
            </div>
    ...
    <?php if ($this->options->JAside_3DTag === 'on') : ?>
        <section class="joe_aside__item tags">
            ...
            <div class="joe_aside__item-contain">
                ...
                <?php else : ?>
                    <div class="empty">Không nhãn hiệu</div>
                <?php endif; ?>
            </div>
        </section>
    <?php endif; ?>
    <?php if ($this->options->JADContent) : ?>
        <a class="joe_aside__item advert" target="_blank" rel="noopener noreferrer nofollow" href="<?php echo explode("||", $this->options->JADContent)[1]; ?>" title="Quảng cáo">
            <img class="lazyload" width="100%" src="<?php _getLazyload() ?>" data-src="<?php echo explode("||", $this->options->JADContent)[0]; ?>" alt="Quảng cáo" />
    ...
    <?php if ($this->options->JAside_Flatterer === 'on') : ?>
        <section class="joe_aside__item flatterer">
            <div class="joe_aside__item-title">
                ...
                <span class="text">Nhật ký chó liếm</span>
                <span class="line"></span>
            </div>
            <div class="joe_aside__item-contain">
