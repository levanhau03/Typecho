...
/**
 * “ Không có nữ nhân trong lòng, thanh mai trúc mã là thiên phú ” <br /> “ Yêu cầu:PHP 5.4 ~ 7.4 ”
 * @package Joe
 * @author Joe
 * @link https://78.al
 */
	...
	<div id="Joe">
		...
		<div class="joe_container">
			<div class="joe_main">
				<div class="joe_index">
									...
									<?php foreach ($recommend as $cid) : ?>
										...
										<figure class="item">
											...
											<figcaption class="information">
												<span class="type">Giới thiệu</span>
					...
					<?php if ($index_ad) : ?>
						<div class="joe_index__ad">
							<a class="joe_index__ad-link" href="<?php echo $index_ad['url'] ?>" target="_blank" rel="noopener noreferrer nofollow">
								...
								<span class="icon">Quảng cáo</span>
							</a>
						</div>
					<?php endif; ?>
					...
					<div class="joe_index__title">
						<ul class="joe_index__title-title">
							<li class="item" data-type="created">Bài viết mới</li>
							<li class="item" data-type="views">Bài viết phổ biến</li>
							<li class="item" data-type="commentsNum">Bình luận nhiều</li>
							<li class="item" data-type="agree">Thích nhiều</li>
							<li class="line"></li>
						</ul>
						<?php
				...
				<div class="joe_load">Xem thêm</div>
			</div>
