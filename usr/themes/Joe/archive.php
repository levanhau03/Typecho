                ...
                <div class="joe_archive">
                                ...
                                <?php if ($this->fields->mode === "default" || !$this->fields->mode) : ?>
                                    <li class="joe_list__item wow default">
                                        ...
                                        <div class="information">
                                            ...
                                            <a class="abstract" href="<?php $this->permalink() ?>" title="Tóm tắt bài viết" target="_blank" rel="noopener noreferrer"><?php _getAbstract($this) ?></a>
                                            <div class="meta">
                                                <ul class="items">
                                                    <li><?php $this->date('Y/m/d'); ?></li>
                                                    <li><?php _getViews($this) ?> Xem</li>
                                                    <li><?php $this->commentsNum('%d'); ?> Bình luận</li>
                                                    <li><?php _getAgree($this) ?> Thích</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </li>
                    ...
                    <?php else : ?>
                        <div class="joe_archive__empty">
                            ...
                            <span>Không tìm thấy kết quả liên quan...</span>
                        </div>
                    <?php endif; ?>
                </div>
                <?php $this->pageNav(
