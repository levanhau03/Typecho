...
?>
    ...
    <div class="joe_config">
        <div>
            <div class="joe_config__aside">
                ...
                <ul class="tabs">
                    <li class="item" data-current="joe_notice">Thông báo mới nhất</li>
                    <li class="item" data-current="joe_global">Thiết lập toàn cầu</li>
                    <li class="item" data-current="joe_image">Cài đặt hình ảnh</li>
                    <li class="item" data-current="joe_post">Cài đặt bài viết</li>
                    <li class="item" data-current="joe_aside">Cài đặt thanh bên</li>
                    <li class="item" data-current="joe_index">Cài đặt trang chủ</li>
                    <li class="item" data-current="joe_other">Các thiết lập khác</li>
                </ul>
                <?php require_once('core/backup.php'); ?>
            </div>
        </div>
        <div class="joe_config__notice">Yêu cầu dữ liệu...</div>
    <?php
    $JFavicon = new Typecho_Widget_Helper_Form_Element_Textarea(
        ...
        'Cài đặt yêu thích trang web',
        'Giới thiệu: Được sử dụng để thiết lập trang web Favicon <br />
         Định dạng: Địa chỉ URL hình ảnh hoặc địa chỉ Base64 <br />
         Khác: Chuyển đổi miễn phí trang web Favicon <a target="_blank" href="//tool.lu/favicon">tool.lu/favicon</a>'
    );
    ...
    $JLogo = new Typecho_Widget_Helper_Form_Element_Textarea(
        ...
        'Giới thiệu: Được sử dụng để đặt logo của trang web, một logo tốt có thể mang lại lượng truy cập hiệu quả cho trang web <br />
         Định dạng: Địa chỉ URL hình ảnh hoặc địa chỉ Base64 <br />
        Khác: tạo trang web logo miễn phí <a target="_blank" href="//www.uugai.com">www.uugai.com</a>'
    );
    ...
    $JCommentStatus = new Typecho_Widget_Helper_Form_Element_Select(
        ...
        '3',
        'Bật hoặc tắt nhận xét trên toàn trang web',
        'Giới thiệu: Được sử dụng để mở và đóng nhận xét trên tất cả các trang <br>
         Lưu ý: Trọng lượng ở đây được ưu tiên cao nhất <br>
         Nếu bạn đóng mục này và mở bình luận trong bài viết thì bình luận sẽ vẫn bị đóng'
    );
